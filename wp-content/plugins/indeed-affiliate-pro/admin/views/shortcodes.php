	<div class="uap-stuffbox">
		...
		<div class="inside">
        	...
        	<div style="margin: 0 auto; display: inline-block;">
	            ...
	            <div class="uap-popup-shortcodevalue"><i class="fa-uap fa-user-uap"></i><?php _e('Header Content', 'uap');?><span>[uap-account-header]</span></div>
	            <div class="uap-popup-shortcodevalue"><i class="fa-uap fa-user-uap"></i><?php _e('Account Content', 'uap');?><span>[uap-account-content]</span></div>
