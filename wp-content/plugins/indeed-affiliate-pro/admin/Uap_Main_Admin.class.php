	...
	class Uap_Main_Admin{
		...
		private function print_account_page(){
			...
			if (!empty($_POST['save'])){
				...
				$indeed_db->save_settings_wp_option('account_header', $_POST);
				$indeed_db->save_settings_wp_option('account_content', $_POST);
			...
			$data['metas'] = $indeed_db->return_settings_from_wp_option('account_header');
			$data['metas'] = $indeed_db->return_settings_from_wp_option('account_content');
